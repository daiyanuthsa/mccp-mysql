</div> <!-- /#admin-content-panel (header.php)-->
...
<div id="admin-bottom-panel" class="border-top d-flex" style="background-color: #fff;">
  <div class="sidebar-panel bg-light border-right d-flex align-items-center">
    <span class="flex-fill text-secondary p-2">
      <small><small>© 2024 › Core Framework</small></small>
    </span>
    <a role="button" class="me-1" title="Mini Sidebar">
      <i class="bi bi-arrow-left-square h4 m-2 text-secondary"></i>
    </a>
  </div>
  <div class="status-panel bg-white flex-fill d-flex align-items-center scroll-x shadow" style="overflow-x: auto;"></div>
